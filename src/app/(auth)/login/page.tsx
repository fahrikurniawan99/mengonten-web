  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">Masukkan kredensial Anda untuk melanjutkan</p>
      </div>
      ...
      <p className="text-center text-sm text-slate-500">
        Belum punya akun?{" "}
        <Link href="/register" className="font-medium text-red-600 transition-colors hover:text-red-700">
          Daftar
        </Link>
      </p>
    </div>
