    ...
    return (
      <div className="space-y-8">
        <div className="flex items-center gap-4">
          <button onClick={backToList} className="flex h-9 w-9 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-500 transition-colors hover:bg-slate-50 hover:text-slate-700">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">Informasi lengkap transaksi Anda</p>
          </div>
        </div>
        ...
        {detailLoading ? (
          ...
          <div className="space-y-6">
            ...
            {detail.payment_proof && (
              <div className="rounded-2xl border border-slate-200 bg-white p-6">
                <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                  <h2 className="text-sm font-semibold text-slate-900">Bukti Pembayaran</h2>
            ...
            {!detail.payment_proof && detail.transaction.status === "pending" && (
              <div className="rounded-2xl border border-slate-200 bg-yellow-50 p-6 text-center">
